 ...
 * Country View class
 */
class LocationdataViewCountry extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo		= LocationdataHelper::getActions('country',$this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		JToolbarHelper::title( JText::_($isNew ? 'COM_LOCATIONDATA_COUNTRY_NEW' : 'COM_LOCATIONDATA_COUNTRY_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					JToolbarHelper::versions('com_locationdata.country', $this->item->id);
				}
				if ($this->canDo->get('country.create'))
				{
		...
		$help_url = LocationdataHelper::getHelpUrl('country');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_($isNew ? 'COM_LOCATIONDATA_COUNTRY_NEW' : 'COM_LOCATIONDATA_COUNTRY_EDIT'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_locationdata/assets/css/country.css"); 
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_locationdata/views/country/submitbutton.js"); 

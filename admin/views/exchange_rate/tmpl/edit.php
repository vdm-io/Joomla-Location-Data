...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'exchange_rateTab', 'details', JText::_('COM_LOCATIONDATA_EXCHANGE_RATE_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('exchange_rate.details_left', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('exchange_rate.details_right', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>

	<?php if ($this->canDo->get('exchange_rate.delete') || $this->canDo->get('exchange_rate.edit.created_by') || $this->canDo->get('exchange_rate.edit.state') || $this->canDo->get('exchange_rate.edit.created')) : ?>
	<?php echo JHtml::_('bootstrap.addTab', 'exchange_rateTab', 'publishing', JText::_('COM_LOCATIONDATA_EXCHANGE_RATE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('exchange_rate.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('exchange_rate.publlshing', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'exchange_rateTab', 'permissions', JText::_('COM_LOCATIONDATA_EXCHANGE_RATE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">

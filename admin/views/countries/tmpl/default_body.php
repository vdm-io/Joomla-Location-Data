...
$edit = "index.php?option=com_locationdata&view=countries&task=country.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = LocationdataHelper::getActions('country',$item,'countries');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td class="nowrap">
			<?php if ($this->user->authorise('currency.edit', 'com_locationdata.currency.' . (int)$item->currency)): ?>
				<div class="name">
					<a href="index.php?option=com_locationdata&view=currencies&task=currency.edit&id=<?php echo $item->currency; ?>&ref=countries"><?php echo $this->escape($item->currency_name); ?></a>
				</div>
			<?php else: ?>

 ...
 */
class LocationdataTableCurrency extends JTable
{
	/**
	...
	{
		parent::__construct('#__locationdata_currency', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_locationdata.currency')); 
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_LOCATIONDATA_CURRENCY_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_locationdata.currency.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_locationdata.currency.'.(int) $this->$k;
	}
